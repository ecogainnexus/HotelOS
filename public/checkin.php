...
<header class="lg:hidden flex items-center justify-between p-4 app-card border-b-0 border-r-0 border-l-0 border-[var(--glass-border)] shrink-0 sticky top-0 z-30">
...
<main class="flex-1 overflow-y-auto w-full p-4 lg:p-8 pb-32 lg:pb-8" x-data="checkinApp()">
    ...
    <?php if ($error): ?>
        <div class="max-w-6xl mx-auto mb-6 bg-red-500/10 border border-red-500/20 text-red-500 px-4 py-3 rounded-lg flex items-center gap-3">
    ...
    <form method="POST" action="" class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-5 space-y-6">
            <div class="app-card rounded-xl p-5 md:p-6 shadow-sm">
                ...
                <!-- Mobile Number -->
                <div class="mb-5">
                    <label class="block mb-2 text-xs font-semibold app-text-muted uppercase">Mobile Number <span class="text-red-400">*</span></label>
                    <div class="flex gap-0 border border-[var(--input-border)] rounded-lg overflow-hidden focus-within:ring-1 focus-within:ring-blue-500 focus-within:border-blue-500 transition-all">
                        <span class="bg-[var(--input-bg)] app-text-muted px-3 py-3 font-mono text-sm flex items-center border-r border-[var(--input-border)]">+91</span>
                ...
                <!-- Full Name -->
                <div class="mb-5">
                    <label class="block mb-2 text-xs font-semibold app-text-muted uppercase">Full Name <span class="text-red-400">*</span></label>
                    <input type="text" name="guest_name" x-model="guestName" required
                        class="app-input w-full px-4 py-3 rounded-lg font-medium focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all" placeholder="Guest Name">
                </div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div class="col-span-1">
                        ...
                        <select name="id_type" x-model="idType" class="app-input w-full px-2 py-3 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="id_number" x-model="idNumber" class="app-input w-full px-4 py-3 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all" placeholder="XXXX">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-7 space-y-6">
            <div class="app-card rounded-xl p-5 md:p-6 shadow-sm">
                <div class="flex items-center justify-between mb-6 pb-4 border-b border-[var(--glass-border)]">
                        ...
                        <span class="bg-[var(--input-bg)] text-[10px] font-bold px-2 py-1 rounded app-text-muted border border-[var(--input-border)]">
                        <?= count($availableRooms) ?> AVAIL
                    </span>
                </div>

                <div class="mb-6">
                    <label class="block mb-2 text-xs font-semibold app-text-muted uppercase">Select Unit <span class="text-red-400">*</span></label>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                        ...
                        <div class="flex items-center bg-[var(--input-bg)] rounded-lg border border-[var(--input-border)]">
                            <button type="button" @click="if(nights>1) { nights--; calculateTotal() }" class="px-3 py-3 app-text-muted hover:app-text-main hover:bg-[var(--glass-border)] transition">-</button>
                            <input type="number" name="nights" x-model="nights" readonly class="w-full bg-transparent text-center font-bold app-text-main outline-none" value="1">
                            <button type="button" @click="if(nights<30) { nights++; calculateTotal() }" class="px-3 py-3 app-text-muted hover:app-text-main hover:bg-[var(--glass-border)] transition">+</button>
                        </div>
                        </div>
                        <div class="col-span-1">
                        <label class="block mb-2 text-xs font-semibold app-text-muted uppercase">Total Rate</label>
                        <div class="px-4 py-3 rounded-lg bg-[var(--input-bg)] border border-[var(--input-border)] app-text-main font-mono font-bold text-center">
                ...
                <div class="bg-[var(--input-bg)] rounded-lg p-4 border border-[var(--input-border)]">
                        ...
                        <div>
                            <input type="number" name="advance_payment" x-model="advancePayment" min="0" @input="calculateTotal()"
                                class="app-input w-full px-4 py-2 rounded text-sm font-bold placeholder-gray-500/50 focus:outline-none focus:ring-1 focus:ring-green-500" placeholder="Advance ₹">
                        </div>
                        <div>
                            <select name="payment_mode" class="app-input w-full px-4 py-2 rounded text-sm focus:outline-none focus:ring-1 focus:ring-green-500">
                        ...
                        <span class="text-lg font-bold text-orange-500 font-mono">₹<span x-text="totalAmount - advancePayment">0</span></span>
                        </div>
                </div>
            </div>
        </div>
